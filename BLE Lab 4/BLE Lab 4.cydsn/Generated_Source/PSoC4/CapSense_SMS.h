...
extern uint8 noiseEnvelopeTbl[CapSense_TOTAL_SENSOR_COUNT];
extern uint8 runningDifferenceTbl[CapSense_TOTAL_SENSOR_COUNT];
extern uint8 signRegisterTbl[CapSense_TOTAL_SENSOR_COUNT];
extern uint16 sampleMinTbl[CapSense_TOTAL_SENSOR_COUNT];
extern uint16 sampleMaxTbl[CapSense_TOTAL_SENSOR_COUNT];
extern uint16 previousSampleTbl[CapSense_TOTAL_SENSOR_COUNT];
extern uint8 kValueTbl[CapSense_TOTAL_SENSOR_COUNT];
