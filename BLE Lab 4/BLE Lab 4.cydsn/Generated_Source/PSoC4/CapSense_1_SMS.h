...
#define CapSense_1_CALIBRATION_MD  		    (1u)
...
extern uint8 noiseEnvelopeTbl[CapSense_1_TOTAL_SENSOR_COUNT];
extern uint8 runningDifferenceTbl[CapSense_1_TOTAL_SENSOR_COUNT];
extern uint8 signRegisterTbl[CapSense_1_TOTAL_SENSOR_COUNT];
extern uint16 sampleMinTbl[CapSense_1_TOTAL_SENSOR_COUNT];
extern uint16 sampleMaxTbl[CapSense_1_TOTAL_SENSOR_COUNT];
extern uint16 previousSampleTbl[CapSense_1_TOTAL_SENSOR_COUNT];
extern uint8 kValueTbl[CapSense_1_TOTAL_SENSOR_COUNT];
