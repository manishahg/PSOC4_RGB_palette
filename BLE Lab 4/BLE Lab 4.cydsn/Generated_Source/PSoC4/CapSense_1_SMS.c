...
/*  Real Charge Divider values */
    ...
    /*  Dividers are not chained */
		...
		const uint8 prescalerTable[CapSense_1_PRESCALERS_TBL_SIZE] = {
...
CapSense_1_CONFIG_TYPE_P4_v2_10 CapSense_1_config;
CapSense_1_CONFIG_TYPE_POINTERS_P4_v2_10 const CapSense_1_configPointers = {
...
void CapSense_1_AutoTune(void)
{
    ...
    CalibrateSensors_P4_v2_10(&CapSense_1_config, CapSense_1_CAL_RAW_COUNT);
    ...
    TunePrescalers_P4_v2_10(&CapSense_1_config);
    ...
    CalibrateSensors_P4_v2_10(&CapSense_1_config, CapSense_1_CAL_RAW_COUNT);
		...
		CapSense_1_NormalizeWidgets(CapSense_1_END_OF_WIDGETS_INDEX, CapSense_1_modulationIDAC);
	#endif /* (0u != CapSense_1_TOTAL_CENTROIDS_COUNT)  */
    TuneSensitivity_P4_v2_10(&CapSense_1_config);
...
void CapSense_1_UpdateThresholds(uint32 sensor)
{
	...
	widget = CapSense_1_widgetNumber[sensor];
		...
		CalculateThresholds_P4_v2_10(&CapSense_1_config, (uint8)sensor, CapSense_1_sensorRaw, (uint8)widget, CapSense_1_fingerThreshold, CapSense_1_noiseThreshold);
