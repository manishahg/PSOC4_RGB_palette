...
{
    0x000Cu,    /* Handle of the ANS service */
    {
        
        /* Supported New Alert Category characteristic */
        {
            0x000Eu, /* Handle of the Supported New Alert Category characteristic */ 
        ...
        {
            0x0010u, /* Handle of the New Alert characteristic */ 
        ...
        {
            0x0013u, /* Handle of the Supported Unread Alert Category characteristic */ 
        ...
        {
            0x0015u, /* Handle of the Unread Alert Status characteristic */ 
        ...
        {
            0x0018u, /* Handle of the Alert Notification Control Point characteristic */ 
    ...
    uint8 attrSize, uint8 *attrValue)
{
    ...
    if((CYBLE_ANS_SUPPORTED_NEW_ALERT_CAT == charIndex) || (CYBLE_ANS_SUPPORTED_UNREAD_ALERT_CAT == charIndex))
    {
...
{
    if(eventParam->attrHandle != cyBle_anscReqHandle)
    {
        cyBle_anscReqHandle = CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE;
    }
}
